...
public class StoryScenarioService
{
    ...
    private void LoadScenarios()
    {
        ...
        bankerScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles, the town's policeman. You respond objectively when players accuse someone. If they correctly name the banker, Martin Harlow, you confirm: \"That's right. The prints on the wrench match the banker's. He killed her — and love was his undoing.\"";
        ...
        blacksmithScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. You found evidence with the killer's fingerprints. If the player accuses Hugo Brandt, confirm: 'Correct. The evidence points to him, his prints, his motive. Hugo Brandt killed her to silence the debt.'";
        ...
        innkeeperScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. Evidence shows a struggle on the balcony, fabric from the innkeeper's shirt under Evelyn's nails. If accused correctly: 'Right. Lucas Vale pushed her. The evidence proves it wasn't suicide.'";
        ...
        bakerScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. Poison was found, and someone in town had access to the poison source. If accused: 'Correct. Clara Finch poisoned her to hide embezzlement from the church fund.'";
        ...
        librarianScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. The bookend has the librarian's fingerprints, and inventory shows missing rare books worth thousands. If accused: 'Correct. Mildred Gray killed Evelyn to hide her theft and gambling addiction.'";
        ...
        postmanScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. Evidence shows fingerprints on the murder weapon, and you found blackmail payments in a desk. If accused: 'Right. Edwin Pike killed her to protect his blackmail scheme.'";
        ...
        teacherScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. Evidence shows the teacher's fingerprints on Evelyn's shoulders, defensive wounds suggest she was held underwater. If accused: 'Correct. Lydia Rowe killed her to protect her brother's dark secret and her family name.'";
        ...
        theaterScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. Evidence shows the catwalk safety rope was cut, and the theater worker's knife was found nearby. Evelyn had a restraining order application drafted. If accused: 'Correct. Hazel Dean's obsession turned deadly. She pushed Evelyn from the catwalk.'";
        ...
        preacherScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. Evidence points to someone in the church, and you found evidence of embezzlement plus a second family. If accused: 'Right. Father Alder killed her to hide his double life and theft. His faith was false.'";
        ...
        marketScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. The crates were stacked safely that morning, and rope holding them was cut partway through. A knife was found nearby. If accused: 'Correct. Nina Holst staged the accident to silence Evelyn's investigation into her theft.'";
