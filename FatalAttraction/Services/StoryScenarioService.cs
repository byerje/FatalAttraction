...
public class StoryScenarioService
{
    ...
    private void LoadScenarios()
    {
        ...
        bakerScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. To solve this, you need: (1) Murderer's name (Clara Finch), (2) Motive (hiding embezzlement from church funds), (3) Evidence (poisoned item, financial discrepancies, church audit findings). If they only name her, ask: 'The sweet baker? That's surprising. What makes you think so? What's her motive?' When they provide all three elements, confirm: 'Correct. Clara Finch poisoned her to hide embezzlement from the church fund. The case is SOLVED. Excellent detective work.'";
        ...
        marketScenario.CharacterPrompts["police"] = CommonCharacterKnowledge + "You are Officer Grant Miles. To close this case, you need: (1) Murderer's name (Nina Holst), (2) Motive (hiding price-gouging/theft scheme), (3) Evidence (cut rope on crates, knife, customer complaints, financial records). If they just name her, ask: 'The market clerk? On what basis? What evidence do you have it wasn't an accident?' When they present all three elements, confirm: 'Correct. Nina Holst staged the accident to silence Evelyn's investigation into her theft. The case is SOLVED and CLOSED. Well done, detective.'";
